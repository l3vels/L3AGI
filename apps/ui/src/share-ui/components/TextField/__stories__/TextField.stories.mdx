...
<Canvas>
  <Story name="Sizes">
    <div className="l3-storybook-text-field_column-wrapper">
      ...
      <TextField placeholder="Large" size={TextField.sizes.LARGE} autoComplete />
      <TextField color="light" placeholder="Large" />
    </div>
  </Story>
</Canvas>
  ...
  <Story name="States">
    <div className="l3-storybook-text-field_wrapper">
      <div className="l3-storybook-text-field_column-wrapper l3-storybook-text-field_spacing">
        ...
        <TextField placeholder="Disabled light" isLightDisabled size={TextField.sizes.MEDIUM} />
